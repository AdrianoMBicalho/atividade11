<?php include("cabecalho-cliente.php"); ?>
    ...
    <table class="table">
				<tr>
        			...
        			<td> 
        				<input class="form-control" type="text" placeholder="EX.: JOSE CARLOS DA ILVA" name="nome" autofocus/><br>
        			</td>
        </tr>
				<tr>
          		<td>E-mail do Cliente:</td>  
        			<td> 
        				<input class="form-control" type="text" placeholder="EX.: josecarlos@josecarlos.com.br" name="email"/>
                <br>
        			</td>
        		</tr>
				<tr>
